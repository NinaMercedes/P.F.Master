...
fastqc *.fastq.gz -o fastqc_results # check htmls in folder for warnings or failures in adapter content (can ignore GC content)
...
cat samples.txt| xargs -I {} -P 10 sh -c "python '/mnt/storage13/nbillows/Pf_09_24/Pfalciparum_09_24_v2/code/fastq2vcf.py' all -1 {}_1.trimmed.fastq.gz -2 {}_2.trimmed.fastq.gz --ref /mnt/storage13/nbillows/Pf_09_24/Pf3D7_v3/Pfalciparum.genome.fasta --p {} --threads 10 --bqsr-vcf #-m bwa-mem2
